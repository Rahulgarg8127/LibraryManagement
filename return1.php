...
<td ><span><?php echo $FINE; ?><a href="delete1.php?B_ID=<?php echo urlencode($B_ID); ?>&amp;TIME=<?php echo urlencode($TIME); ?>&amp;FINE=<?php echo urlencode $FINE; ?>&amp;DAYS=<?php echo urlencode($abcd); ?>&amp;ISSUEDATE=<?php echo urlencode($ISSUE_DATE); ?>&amp;RETURNDATE=<?php echo urlencode($RETURN_DATE); ?>&amp;U_ID=<?php echo urlencode($U_ID); ?>" style="width:90px;"><span style="font-size:12px;" >I </span></a></span></td>
