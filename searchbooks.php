...
<li><a href="searchuser.php"  style="background-color:#7A991A;">SEARCH USER</a></li><br/>
...
<div class="main">
<form class="example" action="view4.php" target="12345" style="margin:auto;max-width:300px">
  <table  class="abc"><tr><td width="100px" align="center"><div style="font-size:24px;">B_ID:</div></td><td width="190px;"><input type="text" placeholder="ENTER B_ID" name="B_ID"></td></tr>
